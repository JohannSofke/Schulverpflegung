...
Mein Name ist Johann Sofke. Als Schüler der Klasse 8a am Carlo-Schmid-Gymnasium Tübingen (CSG), einer offenen Ganztagsschule, nutze ich regelmäßig die Mensa zum Mittagessen. Zu Beginn des Schuljahres 2025/2026 wurde der Caterer aller Tübinger Schulmensen gewechselt; seit der Übernahme durch die Tressbrüder [^TBR] erscheint mir und meinen Mitschülern das Schulessen in mehreren Aspekten schlechter als im Vorjahr: Die Portionen fallen kleiner aus und sättigen nicht, die Gerichte sind in ihrer Makronährstoffzusammensetzung unausgewogen, und die im Speiseplan ausgewiesenen Vor- und Nachspeisen sowie Salate werden häufig nicht mehr serviert.

Auch andere Schüler, Eltern [^STB1], [^STB2] und der Jugendgemeinderat [^JGR1] diskutieren über die Mittagsverpflegung. Allerdings wird überwiegend der Geschmack kritisiert, über den man zwar vortrefflich streiten, aber nicht wissenschaftlich debattieren kann; daneben wird kritisiert, dass die Mittagsverpflegung nicht kindgerecht gestaltet sei – ein Argument, dessen Berechtigung von der konkreten Definition von „kindgerecht“ abhängt; auf diesen Begriff gehe ich im Anhang differenziert ein. Die Frage nach der objektiven, ernährungsphysiologischen Qualität der Mittagsverpflegung blieb in dieser Diskussion bislang weitgehend unbeantwortet. Genau diese Frage zu klären, ist das Anliegen der vorliegenden Arbeit.
...
Dieses Kriterium besagt, dass alle Akteure an der Verpflegung beteiligt sind. Dies ermöglicht eine kontinuierliche Verbesserung und Verfeinerung des Verpflegungskonzeptes und dient der Klärung von Fragen und Problemen. Folgende Akteure müssen beteiligt sein:
